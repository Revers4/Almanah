...
export default function MainPage() {
    return (
        <section className="flex items-center justify-center flex-col min-h-[80vh]">
            <h1 className=" text-4xl font-bold mb-5 md:text-7xl">Hack Frontend</h1>
            ...
            <div>
                <Link className="text-white bg-black dark:bg-white dark:text-black rounded-lg px-4 py-2 mr-5" to={'/knowledge/introduction'}>Начать</Link>
