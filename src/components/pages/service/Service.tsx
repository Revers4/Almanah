...
const Service =() => {
    return (
        <section className="flex flex-col font-normal h-max p-4 ">
            <div className="mb-10 ">
                <h1 className="text-4xl font-semibold text-gray-900 dark:text-gray-100">Раскройте потенциал в IT: проходите собеседования без стресса и получайте высокие офферы</h1>
            </div>
            <div className="grid gap-8 text-gray-900 dark:text-gray-100">
                <div className="rounded-lg text-card-foreground shadow-sm  border border-black/20 dark:border-white/10 bg-transparent">
                    <div className="p-6">
                        <div className="font-semibold text-2xl">Полное сопровождение до оффера</div>
                ...
                <div className="grid gap-6 grid-cols-3 ">
                    <div className="flex flex-col h-full rounded-lg text-card-foreground shadow-sm border border-black/20 dark:border-white/10 bg-transparent">
                        <div className="p-6 flex-grow">
                            <div className="font-semibold text-2xl">Моковое интервью</div>
                            <div className="mt-2 text-zinc-500">
                                <div className="flex items-baseline gap-1">
                                    <span className="text-2xl font-bold">2000 </span>
                                    <p className="text-sm mt-1">₽</p>
                                </div>
                                <span className="text-sm mt-1">Почувствуйте уверенность перед реальным собеседованием</span>
                            </div>
                        </div>
                        <div className="p-6 flex-grow">
                            <ul className="list-disc list-inside mt-2">
                    ...
                    <div className="flex flex-col h-full rounded-lg text-card-foreground shadow-sm border border-black/20 dark:border-white/10 bg-transparent">
                        <div className="p-6 flex-grow">
                            <div className="font-semibold text-2xl break-words">Профессиональное резюме </div>
                            <div className="mt-2 text-zinc-500">
                                <div className="flex items-baseline gap-1">
                                    <span className="text-2xl font-bold">3000</span>
                                    <p className="text-sm mt-1">₽</p>
                                </div>
                                <span className="text-sm mt-1">Выделитесь на фоне сотен кандидатов</span>
                            </div>
                        </div>
                        <div className="p-6 flex-grow">
                            <ul className="list-disc list-inside mt-2">
                    ...
                    <div className="rounded-lg text-card-foreground shadow-sm border border-black/20 dark:border-white/10 bg-transparent">
                        <div className="p-6">
                            <div className="font-semibold text-2xl">Бесплатные материалы</div>
                            <div className="mt-2 text-zinc-500">
                                <div className="flex items-baseline gap-1">
                                    <p className="text-2xl font-bold"> 0 </p>
                                    <span className="text-sm mt-1">₽ навсегда</span>
                                </div>
                                <span className="text-sm mt-1">Начните путь к успеху прямо сейчас</span>
                            </div>
                        </div>
                        <div className="p-6">
                            <ul className="list-disc list-inside mt-2">
